...
//        coEvery { capsuleRepository.getCapsule(serial) } returns flowOf(null)
//
//        val result = getCapsuleBySerialUseCase.execute(GetCapsuleBySerialUseCase.Request(serial)).first()
//
//        assertEquals(Success(GetCapsuleBySerialUseCase.Response(null)), result)
//    }
